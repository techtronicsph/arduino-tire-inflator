...
const int buttonDN = 2;

int PotValue = 0;
int drillSpeed = 0;
const int drillstatuspin = 46;
int drillstatus = 0;
String menuItems[] = {"Center Drill", "Drill Bit 1", "Drill Bit 2", "Drill Bit 3"," "};
...
void setup() {
  ...
  lcd.clear();
      ...
      lcd.clear();
      lcd.setCursor(2, 0);
      lcd.print("Please Untangle");
      lcd.setCursor(1, 1);
      lcd.print("Wire. To Proceed");
...
drillstatus = digitalRead(drillstatuspin);
